	...
	public function renderFeature() {
		...
		if($menuitem) {
			...
			if($params->get('enable_page_title', 0)) {
				...
				$output .= '<div class="sp-page-title ' . $has_bgimage . '"'. $style .'>';
				$output .= '<div class="container">';

				//$output .= '<span class="h2pageTitl">'. $page_title .'</span>';

				//if($page_subtitle) {
					//$output .= '<span class="h3pageTitl">'. $page_subtitle .'</span>';
				//}
