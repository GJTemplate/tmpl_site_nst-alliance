...
if(isset($viewData['class'])){
	...
	$class = 'product-fields customfields2';
}
	...
	<div class="<?php echo $class?>">
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			<div class="product-field product-field-type-<?php echo $field->field_type.' ';
				...
				?>zebra-customfield row">
				<?php if (!$customTitle and $field->custom_title != $custom_title and $field->show_title and !$relCat) { ?>
					<div class="product-fields-title-wrapper col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				if (!empty($field->display)){
                    ...
                    if($relProd || $relCat){ 
                        ...
                        <div class="product-field-display col-lg-6 col-md-6 col-sm-12 col-xs-12"><span><?php echo $field->display ?></span></div>
                    <?php
                    }
				}
