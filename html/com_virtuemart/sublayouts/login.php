    ...
    <form id="com-form-login" action="<?php echo JUri::root(true).'/'.$url; ?>" method="post" name="com-login" >
      <fieldset class="userdata">
        ...
        <div class="width30 floatleft" id="com-form-login-username">
          <input type="text" name="username" class="inputbox" size="18" title="<?php echo vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL'); ?>" onblur="if(this.value=='') this.value='<?php echo addslashes(vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL')); ?>';" onfocus="if(this.value=='<?php echo addslashes(vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL')); ?>') this.value='';" />
        </div>
