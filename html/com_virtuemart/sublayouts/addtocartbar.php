...
if (!VmConfig::get('use_as_catalog', 0)  ) { ?>
	...
	if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($product->product_in_stock - $product->product_ordered) < 1) { ?>
		<a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id.'&tmpl=component'); ?>" class="notify btn btn-default"><?php echo vmText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?></a><?php
	} else {
		...
		<div class="buyme-wr">
			<a href="#" class="b1c btn btn-sm btn-raised btn-default"><?php echo JText::_('COM_VIRTUEMART_BUYME'); ?></a>
		</div>
