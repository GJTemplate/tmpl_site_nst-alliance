...
<table class="html-email" width="100%" cellspacing="0" cellpadding="5" border="0" style="border-collapse: collapse; margin: 0 auto;<?php echo $this->isMail ? ' font-size: 12px;' : ''; ?>">
...
foreach($this->orderDetails['items'] as $item) {
    ...
    if ($this->print and !$this->isPdf) {
        ...
        $product_link = substr(JURI::root(),0,-1). JRoute::_('index.php?option=com_virtuemart&view=productdetails&virtuemart_category_id=' . $item->virtuemart_category_id .'&virtuemart_product_id=' . $item->virtuemart_product_id);
        $product_name = '<a href="'.$product_link.'">'.$item->order_item_name.'</a>';
	}
