	...
	<?php if (($this->params->get('address_check') > 0) &&
		...
		<?php if ($this->contact->address && $this->params->get('show_street_address')) : ?>
			<dd class="address-detail col-sm-4">
				<span class="contact-street" itemprop="streetAddress">
					...
					<span><?php  echo JText::_('TPL_CONTACT_ADDRESS') ;?></span>
		...
		<?php if ($this->contact->state && $this->params->get('show_state')) : ?>
			<dd class="address-detail col-sm-4">
				<span class="contact-state" itemprop="addressRegion">
					<i class="fa fa-location-arrow"></i>
					<span><?php  echo JText::_('TPL_CONTACT_STATE') ;?></span>
		...
		<?php if ($this->contact->postcode && $this->params->get('show_postcode')) : ?>
			<dd class="address-detail col-sm-4">
				<span class="contact-postcode" itemprop="postalCode">
					...
					<span><?php  echo JText::_('TPL_CONTACT_POSTCODE') ;?></span>
		...
		<dd class="address-detail col-sm-4">
			<span class="contact-country" itemprop="addressCountry">
				...
				<span><?php  echo JText::_('TPL_CONTACT_COUNTRY') ;?></span>
...
<?php if ($this->contact->email_to && $this->params->get('show_email')) : ?>
	...
	<dd class="address-detail col-sm-4">
		<span class="contact-emailto">
			...
			<span><?php  echo JText::_('TPL_CONTACT_EMAIL') ;?></span>
...
<?php if ($this->contact->telephone && $this->params->get('show_telephone')) : ?>
	...
	<dd class="address-detail col-sm-4">
		<span class="contact-telephone" itemprop="telephone">
			...
			<span><?php  echo JText::_('TPL_CONTACT_PHONE') ;?></span>
...
<?php if ($this->contact->mobile && $this->params->get('show_mobile')) :?>
	...
	<dd class="address-detail col-sm-4">
		<span class="contact-mobile" itemprop="telephone">
			...
			<span><?php  echo JText::_('TPL_CONTACT_MOBILE') ;?></span>
