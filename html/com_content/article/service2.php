...
?>
	...
	?>
	<div class="article-service-wrap article-details-wrap">
		<div class="entry-header<?php echo $has_post_format ? ' has-post-format': ''; ?>">
			...
			<?php if ($params->get('show_title') || $params->get('show_author')) : ?>
				<h1 itemprop="name" class="service-h">
			...
			<div class="helix-social-share-wrap">
				<?php echo JText::_('SOCIAL_SHARE') . ':' . JLayoutHelper::render('joomla.content.social_share.share', $this->item); //Helix Social Share ?>
			</div>
		</div>
