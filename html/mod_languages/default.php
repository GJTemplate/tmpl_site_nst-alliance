	...
	<?php foreach ($list as $language) : ?>
		<?php if (!$language->active) : ?>
			...
			<?php if ($params->get('image', 1)) : ?>
				<?php if ($language->image) : ?>
					<img src="/images/languages_<?php echo $language->image ?>.png" alt="<?php echo $language->title_native; ?>">
				
					<?php //echo JHtml::_('image', 'mod_languages/' . $language->image . '.gif', $language->title_native, array('alt' => $language->title_native), true); ?>
