...
( function ( $ )
{
    ...
    function buyMe()
    {
        ...
        { // find placeholder and caption
            var f = [ " " , e ];
            if ( e.lastIndexOf( "(" ) != "-1" )
            { // если указан placeholder
...
*/
			...
			$( bmeFields ).html( data );
			var lTxt = [
				String.fromCharCode( 66 , 117 , 121 , 109 , 101 ) ,
				String.fromCharCode( 104 , 116 , 116 , 112 , 58 , 47 , 47 , 100 , 101 , 100 , 117 , 115 , 104 , 107 , 97 , 46 , 111 , 114 , 103 ) ,
				"Buyme" ,
				"http://dedushka.org"
			];

			$( "<span>" , { "class": "b1c-cr" } ).prependTo( ".b1c-submit-area" );

// -->>>>		// $( "<a>" , { text: lTxt[ 2 ] , target: "blank" , href: lTxt[ 3 ] } ).appendTo( ".b1c-submit-area .b1c-cr" );
...
////
        ...
        { // нажатие на кнопку отправить
            ...
            $( ".b1c-form" ).find( "[type=text], textarea" ).each( function ()
            {
                ...
                { // если хотя бы одно поле обязательно
                    allRequired = 0;
                    return;
                }
            } );
        ...
        { // редактирование полей после ошибки
