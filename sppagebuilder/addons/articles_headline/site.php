    ...
    public function render() {
        ...
        if (count($items)) {
            ...
            foreach ($items as $key => $item) {
                ...
                if (!$hide_thumbnail) {
                    if ($item->post_format == 'gallery') {
                        ...
                        if (isset($item->image_small) && $item->image_small) {
                            $output .= '<a href="' . $item->link . '" class="sppb-img-wrapper" rel="nofollow"  itemprop="url"><img class="sppb-img-responsive" src="' . $item->image_small . '" alt="' . $item->title . '" itemprop="thumbnailUrl"></a>';
                        }
                    }
                }
                ...
                if ($show_category) {
                    $output .= '<span class="sppb-meta-category"><a href="' . $item->catUrl . '" itemprop="genre" rel="nofollow">' . $item->category . '</a></span>';
                }
                if ($show_date) {
