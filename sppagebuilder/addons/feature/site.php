...
class SppagebuilderAddonFeature extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        $rhinoicon_name = (isset($this->addon->settings->rhinoicon_name) && $this->addon->settings->rhinoicon_name) ? $this->addon->settings->rhinoicon_name : '';
        ...
        if ($feature_type == 'icon') {
            if ($icon_name || $rhinoicon_name) {
                $media .= '<div class="sppb-icon">';
                if (($title_url && $url_appear == 'icon') || ($title_url && $url_appear == 'both' ))
                    $media .= '<a href="' . $title_url . '">';
                $media .= '<span class="sppb-icon-container">';
                if ($rhinoicon_name) {
                    $media .= '<i class="rhino-icon ' . $rhinoicon_name . '"></i>';
                } else {
        ...
        if ($title) {
            ...
            if (($title_url && $url_appear == 'title') || ($title_url && $url_appear == 'both' ))
                $feature_title .= '<a href="' . $title_url . '">';
    ...
    public static function getTemplate() {
		...
		<#
			...
			if(data.feature_type == "icon") {
				if(data.icon_name || data.rhinoicon_name){
					media += \'<div class="sppb-icon">\';
						if( (data.title_url && data.url_appear == "icon") || (data.title_url && data.url_appear == "both" ) ){
							media += \'<a href="\'+data.title_url+\'">\';
						}
						media += \'<span class="sppb-icon-container">\';
                                                    if (data.rhinoicon_name) {
                                                        media += \'<i class="rhino-icon \' + data.rhinoicon_name + \'"></i>\';
                                                    } else {
